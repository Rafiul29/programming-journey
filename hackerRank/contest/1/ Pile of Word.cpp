...
. You need to determine if the strings are Pile of Word of each other.
...
Each line of the test case will contain
and

    separated by a space. The string will contain Enlish small alphabets only.
...
if the strings are Pile of Word to each other,
